...
<body>
	...
	<div class="container col-lg-7">
		<h1 class="text-center" style="font-weight: bold; font-size: 36px; margin-bottom: 30px">Travelling Salesman Problem</h1>
		<div class="card">
			<div class="card-body">
				<form method="post" class="form-group" action="uploadServlet"
					...
					<div class="form-group">
						<label for="Profile Photo">File Data:</label> <input
							type="file" name="photo" size="45" />
					</div>
